...
@section('container')
    <h1 class="text-center text-4xl my-3">HALAMAN CREATE</h1>

    <form action="{{ route('products.index') }}" method="POST" class="max-w-md mx-auto" enctype="multipart/form-data">
        @csrf
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="file" name="image" id="image" class="block py-2.5 px-0 text-sm text-gray-900"
                placeholder=" " />
            <label for="image"
